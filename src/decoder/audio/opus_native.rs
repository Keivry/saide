...
/// Native Opus decoder (using libopus directly)
pub struct OpusNativeDecoder {
    decoder: Decoder,
    sample_rate: u32,
    channels: u16,
}

impl OpusNativeDecoder {
...
impl AudioDecoder for OpusNativeDecoder {
...
mod tests {
    ...
    fn test_opus_native_decoder_creation() {
        let decoder = OpusNativeDecoder::new(48000, 2);
        assert!(decoder.is_ok());
    }

    #[test]
    fn test_opus_native_invalid_sample_rate() {
        let decoder = OpusNativeDecoder::new(44100, 2);
